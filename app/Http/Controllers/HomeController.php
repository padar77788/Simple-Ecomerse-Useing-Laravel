...
class HomeController extends Controller
{
    ...
    {
        $products = filter_products(Product::orderBy('created_at', 'desc'))->paginate(20);
    ...
    public function privacypolicy(){
       ...
       public function howtobuy(){
        return view("frontend.policies.howtobuy");
    }
       public function cashondelivery(){
        return view("frontend.policies.cashondelivery");
    }
       public function sellercorner(){
        return view("frontend.policies.sellercorner");
    }
