...
Route::get('/cashondelivery', 'HomeController@cashondelivery')->name('cashondelivery');
Route::get('/sellercorner', 'HomeController@sellercorner')->name('sellercorner');
...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::post('/products/hot', 'ProductController@updateHot')->name('products.hot');
	Route::post('/products/instagram', 'ProductController@updateInstagram')->name('products.instagram');
