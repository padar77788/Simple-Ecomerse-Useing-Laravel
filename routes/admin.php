...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/howtobuy/{type}', 'PolicyController@index')->name('howtobuy.index');
	Route::get('/cashondelivery/{type}', 'PolicyController@index')->name('cashondelivery.index');
	Route::get('/sellercorner/{type}', 'PolicyController@index')->name('sellercorner.index');
