                                ...
                                <li>
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ areActiveRoutes(['privacypolicy.index'])}}">
                                         ...
                                         <li class="{{ areActiveRoutes(['howtobuy.index'])}}">
                                            <a class="nav-link" href="{{route('howtobuy.index', 'how_to_buy')}}">{{__('How To Buy')}}</a>
                                        </li>
                                         <li class="{{ areActiveRoutes(['cashondelivery.index'])}}">
                                            <a class="nav-link" href="{{route('cashondelivery.index', 'cash_on_delivery')}}">{{__('Cash On Delivery')}}</a>
                                        </li>
                                         <li class="{{ areActiveRoutes(['sellercorner.index'])}}">
                                            <a class="nav-link" href="{{route('sellercorner.index', 'seller_corner')}}">{{__('Seller Corner')}}</a>
                                        </li>
