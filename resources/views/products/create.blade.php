			...
			<div class="panel-body">
				<div class="tab-base tab-stacked-left">
				    ...
				    <ul class="nav nav-tabs">
						...
						<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-8" aria-expanded="false">{{__('Conditions')}}</a>
				        </li>
						{{-- <li class="">
				    ...
				    <div class="tab-content">
						...
						<div id="demo-stk-lft-tab-7" class="tab-pane fade">
							<div class="form-group">
								...
								<div class="col-lg-9">
									...
									<label style="font-size: 20px;margin-top: 20px;" >Short Description</label>
						...
						<div id="demo-stk-lft-tab-8" class="tab-pane fade">
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Conditions')}}</label>
								<div class="col-lg-9">
									<textarea class="editor" name="condition"></textarea>
								</div>
							</div>
				        </div>
