<div id="main-menu-container" class="header mobile-side-menu bg-white">
    <!-- Top Bar -->
...
<script>
    ...
    <div class="top-navbar bg-warning">
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 ">
                    <marquee>
                        <ul class="inline-links">
                            <li class='ml-5 top-bar-item'>Hotline : +8801516154952 ( 9 AM to 11 PM - Everyday ) Thank You.</li>
                        </ul>
                    </marquee>
                </div>
    ...
    <div   class= "position-relative logo-bar-area mb-3">
        <div class="">
            <div class="container">
