...
.container {
    ...
    <section class="home-banner-area mb-4">
        <div class="">
            ...
            <!--</section>-->
             ...
             <section class="slice-sm footer-top-bar __offer-section">
                <div class="container sct-inner">
                    <div class="row no-gutters">
                        <div class="col-lg-4 col-md-4">
                            <div class="footer-top-box __box">
                                <a href="#">
                                    <div class="__parent">
                                        <div class="__icon">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="footer-top-box __box __after">
                                <a href="#">
                                    <div class="__parent">
                                        <div class="__icon">
                                            <i class="la la-tag"></i>
                                        ...
                                        <div class="__content">
                                            <h4>TAKE 15% OFF</h4>
                                            <p>ORDERS CONTAIN 4 TREASURES</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            <section class="__offer-section-small">
                <marquee>
                    <div class="__item">
                        <span class="_icon"><i class="la la-truck"></i></span>
                        <span class="_heading">FREE SHIPPING</span>
                        <span>ORDER OVER $69</span>
                    </div>

                    <div class="__item">
                        <span class="_icon"><i class="la la-file"></i></span>
                        <span class="_heading">10% OFF</span>
                        <span>SITEWIDE</span>
                    </div>

                    <div class="__item">
                        <span class="_icon"><i class="la la-tag"></i></span>
                        <span class="_heading">TAKE 15% OFF</span>
                        <span>ORDERS CONTAIN 4 TREASURES</span>
                    </div>
                </marquee>
            </section>
    ...
    <section class="mb-4">
        <div  style=" max-width: 1220px !important;" class="container">
            <div class="p-4 bg-white shadow-sm">
                <div class="section-title-home clearfix">
                    <h3 class="heading-5 strong-700 mb-0 text-center">
                        <span class="mr-4">{{__('Featured Products')}}</span>
                    </h3>
                </div>
                <div class="row">
                    @foreach ($data=filter_products(\App\Product::where('published', 1)->where('featured', '1'))->limit(8)->get() as $key => $product)

                    <div class="col-md-3 col-lg-3 col-6 p-0">
        ...
        <div  style=" max-width: 1220px !important;" class="container">
            <div class="p-4 bg-white shadow-sm">
                <div class="section-title-home clearfix">
                    ...
                    <h3 class="heading-5 strong-700 mb-0 text-center">
                        <span class="mr-4">{{" WHAT'S NEW"}}</span>
                    </h3>
                </div>
                ...
                <div class="caorusel-box">
                    <div class="slick-carousel" data-slick-items="4" data-slick-xl-items="4" data-slick-lg-items="4"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2">
                        @foreach ($data=filter_products(\App\Product::where('hot', 1)->where('featured', '1'))->limit(8)->get() as $key => $product)
                        <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                            <div class="card-body p-0">
        ...
        <section class="mb-4">
            <div  style=" max-width: 1220px !important;" class="container">
                <div class="p-4 bg-white shadow-sm">
                    ...
                    <div class="caorusel-box">
                        <div class="slick-carousel" data-slick-items="4" data-slick-xl-items="4" data-slick-lg-items="4"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2">
                            @foreach ($best=filter_products(\App\Product::where('published', 1)->orderBy('num_of_sale', 'desc'))->paginate(8) as $key => $product)
                            <div class="product-card-2 card card-product m-2 shop-cards shop-tech">
                                <div class="card-body p-0">
        ...
        <div  style=" max-width: 1220px !important;" class="container">
            <div class="p-4 bg-white shadow-sm">
                <div class="section-title-home clearfix">
                    ...
                    <h3 class="heading-5 strong-700 mb-0 text-center">
                        <span class="mr-4">{{"Products On Instagram"}}</span>
                    </h3>
                </div>
                <div class="row">
                    @foreach ($data=filter_products(\App\Product::where('instagram', 1)->where('featured', '1'))->limit(8)->get() as $key => $product)

                    <div class="col-md-2 col-lg-2 col-6 p-0">
                        <div  class="product-card-2 card card-product m-2 shop-cards shop-tech">
                            <div class="card-body p-0">
                                <div class="card-image">
                                    <a style="height: 230px" href="{{ route('product', $product->slug) }}" class="d-block">
                                        <img src="{{ asset($product->featured_img) }}" style='width:100%;'>
                                    </a>
                                </div>
