...
.logo-bar-icons .nav-search-box .nav-box-link, .logo-bar-icons .nav-compare-box .nav-box-link, .logo-bar-icons .nav-wishlist-box .nav-box-link, .logo-bar-icons .nav-cart-box .nav-box-link {
...
.top-navbar ul.inline-links > li, ul.inline-links > li > a {
...
<div class="header bg-white ">
    ...
    <!-- Top Bar -->
     ...
     <div class="top-navbar " style="color:white !important;background-color:gray">
                ...
                <div class="col-4">
                    ...
                    <marquee>
                        ...
                        <ul class="inline-links">
                            ...
                            <li class='ml-5 top-bar-item'>Hotline : {{ $generalsetting->phone }} ( 9 AM to 11 PM - Everyday ) Thank You.</li>
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    ...
                    <ul class="inline-links">
                        ...
                        <li>
                            ...
                            <a href="{{ route('howtobuy') }}" class="top-bar-item">{{__('How to Buy')}}</a>

                        </li>

                        <li>

                            <a href="{{ route('cashondelivery') }}" class="top-bar-item"> {{__('Cash on Delivery')}}</a>

                        </li>

                        <li>

                            <a href="{{ route('sellercorner') }}" class="top-bar-item"> {{__('Seller Corner')}}</a>
...
<div id='main-menu-container'>
    ...
    <div  class="position-relative logo-bar-area">
        ...
        <div class="">
            ...
            <div class="container-fluid" id='nav-scroll'>

                <div class="row no-gutters align-items-center">

                    <div class="col-lg-3 col-12" style="position:absolute">
                                ...
                                <form action="{{ route('search') }}" method="GET">
                                    ...
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="d-lg-none search-box-back">
                                         ...
                                         <i id='btn_src' style='color: black;font-size: 23px;font-weight: bold;' class="la la-search la-flip-horizontal"></i>



                                        <div class="w-100">

                                            <input style='border-radius:30px' type="text" aria-label="Search" id="search" name="q" class="w-100 ds-box d-none" placeholder="I'm shopping for..." autocomplete="off">
                                       ...
                                       <!-- <button  style='background: none;margin-left: -42px;color: black;' class="d-none d-lg-block" type="submit">

                                            <i class="la la-long-arrow-left"></i></i>
                    ...
                    <div class="col-lg-4 col-0  position-static"></div>
                        <div class="col-lg-4 col-9 text-center position-static">
                            ...
                            <a class="navbar-brand" href="{{ route('home') }}">
                                ...
                                @if($generalsetting->logo != null)
                                    ...
                                    <img src="{{ asset($generalsetting->logo) }}" class="" alt="joe shop">

                                @else

                                    <img src="{{ asset('frontend/images/logo/logo.png') }}" class="" alt="joe shop">
                    ...
                    <div class="col-lg-4 col-3 position-static">
                            ...
                            <div class="logo-bar-icons d-inline-block ml-auto">
                                ...
                                <div class="d-none d-lg-inline-block">
                                    ...
                                    <div class="nav-wishlist-box" >
                                        ...
                                        <a href="{{ route('dashboard') }}" class="nav-box-link ">

                                            <span class="nav-box-text d-none d-xl-inline-block auth-css-me"><i class="fa fa-user"></i>  {{__('My Profile')}}</span>
                                ...
                                <div class="d-none d-lg-inline-block">
                                    ...
                                    <div class="nav-wishlist-box" >
                                        ...
                                        <a href="{{ route('logout') }}" class="nav-box-link">
                                            ...
                                            <span class="nav-box-text d-none d-xl-inline-block auth-css-me"><i class="glyphicon glyphicon-log-out"></i>  {{__('Logout')}}</span>
                                     ...
                                     <div class="d-none d-lg-inline-block">
                                        ...
                                        <div class="nav-wishlist-box" >
                                             ...
                                             <a  href="{{ route('user.login') }}">
                                                ...
                                                <span class="nav-box-text d-none d-xl-inline-block auth-css-me">Sign In</span>

                                            </a>

                                            <a href="{{ route('user.registration') }}">

                                                <span class="nav-box-text d-none d-xl-inline-block auth-css-me">/Sign Up</span>
            ...
            <div class="container">
                ...
                <div class="row no-gutters position-relative">
                    ...
                    <div class="col-lg-3 position-static">
                        ...
                        <div style='margin-top:-8px' class="category-sidebar" id="category-sidebar">
        ...
        <div class="main-nav-area d-none d-lg-block">
            <div class="row">
                <div class="col-md-2 text-right">
                    <a class="navbar-brand d-none" href="{{ route('home') }}" id='scroll-left-side'>
                            ...
                            <div class="collapse navbar-collapse align-items-center justify-content-center" id="navbar_main">
                                ...
                                <ul id='mynav' class="navbar-nav">
                                     ...
                                     @foreach (\App\Category::all()->take(11) as $key => $category)
                                            ...
                                            <a class="nav-link" href="{{ route('products.category', $category->id) }}"><span class="cat-name">{{ __($category->name) }}</span></a>
                                            ...
                                            @if(count($category->subcategories)>0)
                                                ...
                                                <div class="submenu">
                                                    ...
                                                    <li>
                                                      ...
                                                      <a href="{{ route('products.subcategory', $subcategory->id) }}" >{{ __($subcategory->name) }} @if(count($subcategory->subsubcategories)>0) &#8658; @endif</a>
                                                      ...
                                                      <ul>
                                                        ...
                                                        <li>
                                                          ...
                                                          <a href="{{ route('products.subsubcategory', $subsubcategory->id) }}">{{ __($subsubcategory->name) }}</a>
                ...
                <div class="col-md-2">
                    ...
                    <div class="d-inline-block" data-hover="dropdown" >
                        ...
                        <div class="nav-cart-box dropdown scroll-right-side" id="cart_items" style="display:none">
