...
<!-- Bootstrap -->
<link rel="stylesheet" href="{{ asset('frontend/all/css/all.css') }}" type="text/css">

@if(\App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1)
     <!-- RTL -->

    <link type="text/css" href="{{ asset('frontend/old/css/active.rtl.css') }}" rel="stylesheet">

@endif

<link href="{{ asset('frontend/old/css/colors/'.\App\GeneralSetting::first()->frontend_color.'.css')}}" rel="stylesheet">
<!-- jQuery -->
...
<script src="{{ asset('frontend/all/css/all.js') }}"></script>
...
@yield('script')
 ...
 <script>
                                            ...
                                            $('#btn_src').click(function(){
                                                ...
                                                $('.ds-box').addClass('d-block');

                                                $('#btn_src').addClass('d-none')
...
<script>
    ...
    $("document").ready(function($){
        ...
        var scroll = $('#nav-scroll');
        var scroll_left=$('#scroll-left-side');
        var scroll_right=$('.scroll-right-side');
        var scroll_bar=$('.logo-bar-area');
        ...
        $(window).scroll(function () {
            ...
            if ($(this).scrollTop() > 125) {
                ...
                if (width > 991 ) {
                    ...
                    scroll_bar.css('padding-top','0px');
                ...
                if (width > 991 ) {
                    ...
                    scroll_bar.css('padding-top','20px');
...
<script>
  ...
  div.setAttribute('page_id', '1010949739016252');
...
<div class="fb-customerchat"
  	...
  	page_id="1010949739016252"

  	logged_in_greeting="Hi Sir, How can we help you? If need Emergency call us +88 01730233032"

  	logged_out_greeting="Hi Sir, How can we help you? If need Emergency call us +88 01730233032">
