                        ...
                        <div class="product-description-wrapper">
                            ...
                            @if(home_price($product->id) != home_discounted_price($product->id))
                                ...
                                <div class="row no-gutters mt-4">
                                    <div class="col-2">
                                        <div class="product-description-label">Size:</div>
                                    </div>
                    ...
                    <div class="product-desc-tab bg-white">
                        <div class="tabs tabs--style-2">
                            <ul class="nav nav-tabs justify-content-center sticky-top bg-white">
                                ...
                                <li class="nav-item">
                                    <a href="#tab_default_5" data-toggle="tab" class="nav-link text-uppercase strong-600  show">{{__('Conditions')}}</a>
                                </li>
                            ...
                            <div class="tab-content pt-0">
                                ...
                                <div class="tab-pane  show" id="tab_default_5">
                                    <div class="py-2 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
